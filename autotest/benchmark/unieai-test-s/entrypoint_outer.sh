...
echo "run unieai-test-s benchmark on port $port with model from $model_path (model name is $model_name) using $concurrency concurrency, $output_tokens output tokens"
